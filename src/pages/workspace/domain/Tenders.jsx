...
import { TenderModal } from '../../../components/tender';
            ...
            <div className={`w-full ${tenderModalOpen ? 'hidden' : ''}`}>
                <div className="flex justify-between space-x-10 pb-5 bg-slate-100">
                    ...
                    <div className={"space-x-5"}>
                        <button className={"p-2 text-gray-100 rounded-lg dark:text-white bg-darkBlue hover:bg-blue-400 hover:cursor-pointer"}>Создать Тендер</button>
                    </div>
                </div>
