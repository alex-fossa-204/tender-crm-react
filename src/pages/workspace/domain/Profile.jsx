    ...
    return (
        <WorkspacePage>
            <div className='grid grid-rows-3 grid-flow-col gap-4'>
                <div className='col-span-1 row-span-3 flex flex-col justify-center bg-blue-50 drop-shadow-xl'>
                ...
                <div className='col-span-2 row-span-2 bg-blue-50 drop-shadow-xl p-4'>
                    <p className='text-xl font-bold'>Персональные данные пользователя</p>
